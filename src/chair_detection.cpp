...
float distances[6];
float table_reference[] = {0.29, 0.34, 0.38, 0.50};
...
void publish_table_legs_marker(fyp2017_18::table_info detected) {
  ...
  table_legs_marker.ns = "chair legs";
  table_legs_marker.id = 3;
  ...
  table_legs_marker.color.r = 0.0f;    // red marker
...
void publish_table_CG_marker(fyp2017_18::table_info detected) {
  ...
  table_CG_marker.ns = "chair CG";
  table_CG_marker.id = 4;
  ...
  table_CG_marker.color.g = 1.0f;    // light red marker
...
void laser_scan_front(const fyp2017_18::cluster_info::ConstPtr& laser_msg) {
  ...
  */
  ...
  float min_side = 0.29;    // shortest side is chosen
  float side_length = 0.38;    // adjacent to shortest side
...
int main(int argc, char** argv) {
  ...
  table_legs_marker_pub = n.advertise<visualization_msgs::Marker>("visualize_chair_legs", 10);
  table_CG_marker_pub = n.advertise<visualization_msgs::Marker>("visualize_chair_CG", 10);
  table_info_pub = n.advertise<fyp2017_18::table_info>("chair", 10);
